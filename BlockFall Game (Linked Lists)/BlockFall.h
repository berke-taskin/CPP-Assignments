...
public:
    ...
    vector<vector<bool>> rotateRight(const vector<vector<bool>> &block); //Finds the rotated right version of block
    vector<vector<bool>> rotateLeft(const vector<vector<bool>> &block); //Finds the rotated left version of block
};
